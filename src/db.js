...
const TENANT_TABLES=['customers','sales','sale_items','capacity_pools','services','staff','service_staff','staff_attendance','staff_commission_rules','products','packages','expenses','users','audit_logs','settings','appointments','loyalty_transactions','referral_credit_transactions','password_reset_tokens','whatsapp_webhook_events'];
